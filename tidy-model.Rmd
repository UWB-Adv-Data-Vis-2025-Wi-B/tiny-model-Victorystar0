...
ggplot(crickets, aes(x = rate, fill = species)) +
  ...
  ggtitle("Distribution of the chirp rate of crickets by species") +
...
```
This graph shows the interraction between temperature and chirp rates of two species of crickets.
